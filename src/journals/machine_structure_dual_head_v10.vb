...
Module MachineStructureDualHeadV10
    ...
    Const ToolFaceX As Double = 10.0
    ...
    Sub Main()
        ...
        Dim partTag As Tag
        Dim partName As String = "C:\Users\RyanW\Documents\Codex\2026-04-23-ug-cli-ide\assets\samples\machine_structure_dual_head_v10"
    ...
    Sub CreateSceneAxes()
        CreateLine(New Double() {-95.0, 0.0, 0.0}, New Double() {125.0, 0.0, 0.0}, 2)
        CreateLine(New Double() {0.0, -80.0, 0.0}, New Double() {0.0, 80.0, 0.0}, 3)
        CreateLine(New Double() {0.0, 0.0, -60.0}, New Double() {0.0, 0.0, 90.0}, 4)
    End Sub
    ...
    Sub CreateTwoFixedHeads()
        ' Exactly two physical grinding heads: rough head and finish head.
        CreateHead("rough", -13.0, 18.0, RoughWheelRadius, RoughWheelThickness, 186)
        CreateHead("finish", 13.0, 26.0, FinishWheelRadius, FinishWheelThickness, 211)
    End Sub

    Sub CreateHead(ByVal name As String, ByVal yOffset As Double, ByVal zOffset As Double, ByVal wheelRadius As Double, ByVal wheelThickness As Double, ByVal color As Integer)
        Dim axis() As Double = {0.58, 0.0, 0.81}
        Dim wheelCenter() As Double = {ToolFaceX + 8.0, yOffset, zOffset}
        ...
        CreateLine(New Double() {ToolFaceX, yOffset, zOffset}, wheelCenter, color)
    End Sub
