...
Module SingleStationCollisionModelV7DiameterX
    Dim theSession As Session
    Dim theUfSession As UFSession
    Dim ci As CultureInfo = CultureInfo.InvariantCulture

    Const WorkpieceRadius As Double = 25.4
    Const ChuckRadius As Double = 36.0
    Const FixtureBackRadius As Double = 30.0
    Const WheelRadius As Double = 32.0
    Const WheelThickness As Double = 6.0
    ...
    Sub Main()
        ...
        Dim partTag As Tag
        Dim partName As String = "C:\Users\RyanW\Documents\Codex\2026-04-23-ug-cli-ide\assets\samples\single_station_collision_model_v7_diameter_x"
    ...
    Sub CreateSingleStation()
        TryCreateCylinderZ(0.0, 0.0, -3.0, 6.0, WorkpieceRadius * 2.0, 36)
        TryCreateCylinderZ(0.0, 0.0, -16.0, 13.0, ChuckRadius * 2.0, 31)
        TryCreateCylinderZ(0.0, 0.0, -30.0, 14.0, FixtureBackRadius * 2.0, 8)
        CreateCylinderWire(0.0, 0.0, -3.0, 3.0, WorkpieceRadius, 36)
        CreateCylinderWire(0.0, 0.0, -16.0, -3.0, ChuckRadius, 31)
        CreateCylinderWire(0.0, 0.0, -30.0, -16.0, FixtureBackRadius, 8)
    ...
    Sub CreateSceneAxes()
        CreateLine(New Double() {-60.0, 0.0, 0.0}, New Double() {80.0, 0.0, 0.0}, 2)
        CreateLine(New Double() {0.0, -70.0, 0.0}, New Double() {0.0, 70.0, 0.0}, 3)
    ...
    Sub CreateToolSnapshot(ByVal x As Double, ByVal z As Double)
        ...
        Dim shankDir() As Double = {0.88, 0.0, 0.48}
